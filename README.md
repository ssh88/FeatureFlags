...
When I was working on the miPic app, I was eager to implement a feature flagging tool. This was not only to be able to hide unfinished features behind a flag but to also show the rest of the team the power of feature flagging, from a/b testing to being able to remotely change things independent of a back-end.
...
In conjunction with this JSON file, I created a plist config file to declare the following properties
 ...
 |	outputFilePath			          |	file path for the generated files        | 
 |	outputFilename			          |	filename/prefix for generated file  	    | 
